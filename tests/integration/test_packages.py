...
import pytest
from debmagic.cli import main as debmagic_main
...
RUN --mount=from=dist,target=/tmp/dist python3 -m pip install --break-system-packages /tmp/dist/debmagic_api*.whl
"""
